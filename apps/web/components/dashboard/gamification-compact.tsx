    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-xl bg-[#5B3FD4]/10 flex items-center justify-center">
            <Zap className="w-3.5 h-3.5 text-[#5B3FD4]" />
          </div>
          <div>
        ...
        <Link href="/gamificacao" className="flex items-center gap-0.5 text-[11px] font-medium text-[#5B3FD4]">
      ...
      <div className="mb-3">
        ...
        <div className="w-full h-2 rounded-full" style={{ backgroundColor: 'var(--border)' }}>
          <div className="h-2 rounded-full bg-[#5B3FD4] transition-all" style={{ width: `${pct}%` }} />
        </div>
      </div>
          ...
          {missions.slice(0, 3).map((m) => (
            <div key={m.id} className="flex items-center gap-2">
              <div
                ...
                style={{ borderColor: m.completed ? '#52D68A' : 'var(--border)', backgroundColor: m.completed ? '#52D68A' : 'transparent' }}
              >
